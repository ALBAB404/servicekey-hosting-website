          ...
          <div class="row align-items-center justify-content-between">
            <div class="col-lg-4 col-md-4 col-12">
              <div class="card text-center single-pricing-pack">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn outline-btn mb-3" target="_blank"
                    >Purchase now</a
                  >
                </div>
              </div>
            ...
            <div class="col-12">
              <div class="support-cta mt-5">
                ...
                >
                  <span class="ti-loop color-primary mr-3 icon-sm"></span>Choose
                  Your
                  <a href="pricing-comparison.html" class="ml-2"
                    >Compare Hosting Plans</a
                  >
                </h5>
              </div>
            </div>
